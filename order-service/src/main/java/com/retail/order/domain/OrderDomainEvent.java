...
@Entity
@Table(name = "order_domain_events", uniqueConstraints = @jakarta.persistence.UniqueConstraint(
    name = "uk_order_domain_event_aggregate_version",
...
public class OrderDomainEvent {
    ...
    public OrderDomainEvent(UUID eventId, String aggregateType, Long aggregateId, long aggregateVersion,
